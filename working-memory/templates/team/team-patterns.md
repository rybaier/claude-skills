...
## Naming Conventions
- <!-- e.g., Branch format: {type}/{ticket}-{short-description} -->

## Workflow
- <!-- e.g., Deploy to staging before any production release -->

## Communication
- <!-- e.g., PR descriptions must include a "Test Plan" section -->

## Architecture Decisions
- <!-- e.g., All new services use the shared auth middleware -->
