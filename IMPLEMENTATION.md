...
## Phase 1: Strengthen Core Identity (F1 + F2 + F3)
- [x] Add metadata comments to profile.md template
- [x] Add metadata comments to collaboration-patterns.md template
...
- [x] Update update.sh — template copy loop + migration notice
